...
MARKER_PRODUCT_CODES = [
    ...
    MarkerProductCodeDef(3100, "DOM-EXPRESS", "Domestic Express Cargo Uplift", "DOMESTIC", "SURCHARGE", "STANDARD", "4490", "5490"),
    MarkerProductCodeDef(3101, "DOM-VALUABLE", "Domestic Valuable Cargo Uplift", "DOMESTIC", "SURCHARGE", "STANDARD", "4490", "5490"),
    MarkerProductCodeDef(3102, "DOM-LIVE-ANIMAL", "Domestic Live Animal Uplift", "DOMESTIC", "SURCHARGE", "STANDARD", "4490", "5490"),
    MarkerProductCodeDef(3103, "DOM-OVERSIZE", "Domestic Oversize Cargo Uplift", "DOMESTIC", "SURCHARGE", "STANDARD", "4490", "5490"),
]
...
LAUNCH_RULES = [
    ...
    _rule(
        ...
        service_scope="A2A",
        commodity_code="SCR",
        product_code="DOM-EXPRESS",
        leg="MAIN",
        trigger_mode="AUTO",
        notes="Domestic express cargo pricing uses the launch multiplier tariff.",
    ),
    _rule(
        shipment_type="DOMESTIC",
        service_scope="A2D",
    ...
    _rule(
        ...
        leg="MAIN",
        trigger_mode="AUTO",
        notes="Domestic live animal pricing uses the launch multiplier tariff.",
    ),
    _rule(
        shipment_type="DOMESTIC",
        service_scope="A2D",
    ...
    _rule(
        ...
        leg="MAIN",
        trigger_mode="AUTO",
        notes="Domestic valuable cargo pricing uses the launch multiplier tariff.",
    ),
    _rule(
        shipment_type="DOMESTIC",
        service_scope="A2D",
    ...
    _rule(
        ...
        service_scope="A2A",
        commodity_code="OOG",
        product_code="DOM-OVERSIZE",
        leg="MAIN",
        trigger_mode="AUTO",
        notes="Domestic oversized cargo pricing uses the launch multiplier tariff.",
    ),
    _rule(
        shipment_type="DOMESTIC",
        service_scope="A2D",
    ...
    _rule(
        ...
        service_scope="A2A",
        commodity_code="DG",
        product_code="DOM-DG-HANDLING",
        leg="MAIN",
        trigger_mode="AUTO",
        notes="Domestic DG handling fee exists in the tariff, but DG routing remains SPOT-controlled at launch.",
    ),
    _rule(
        shipment_type="DOMESTIC",
        service_scope="A2D",

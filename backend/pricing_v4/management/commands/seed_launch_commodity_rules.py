...
LAUNCH_RULES = [
    ...
    _rule(
        ...
        leg="DESTINATION",
        trigger_mode="REQUIRES_MANUAL",
        notes="Import DG local charges and permits are not yet standardized in DB.",
    ),
    _rule(
        shipment_type="IMPORT",
        service_scope="D2D",
    ...
    _rule(
        ...
        leg="DESTINATION",
        trigger_mode="REQUIRES_MANUAL",
        notes="Import live animal handling remains manual pending destination tariff setup.",
    ),
    _rule(
        shipment_type="IMPORT",
        service_scope="D2D",
    ...
    _rule(
        ...
        leg="DESTINATION",
        trigger_mode="REQUIRES_MANUAL",
        notes="Import high-value handling remains manual pending destination tariff setup.",
    ),
    _rule(
        shipment_type="IMPORT",
        service_scope="D2D",

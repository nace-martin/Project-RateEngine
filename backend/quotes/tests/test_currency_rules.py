...
class PricingServiceV4AdapterCurrencyTests(SimpleTestCase):
    ...
    def test_adapter_export_prepaid_pom_bne_outputs_aud(self):
        self.assertEqual(self._adapter_for("PREPAID", "AU").get_output_currency(), "AUD")

    def test_adapter_export_prepaid_pom_non_au_outputs_usd(self):
        self.assertEqual(self._adapter_for("PREPAID", "SG").get_output_currency(), "USD")

    def test_adapter_export_collect_pom_bne_outputs_pgk(self):
        self.assertEqual(self._adapter_for("COLLECT", "AU").get_output_currency(), "PGK")

    def test_adapter_export_collect_pom_non_au_outputs_pgk(self):
        self.assertEqual(self._adapter_for("COLLECT", "HK").get_output_currency(), "PGK")

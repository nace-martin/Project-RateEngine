...
from .public_links import get_public_quote_id_from_token
...
class QuotePDFAPIView(APIView):
    ...
    def get(self, request, quote_id):
        ...
        from .pdf_service import generate_quote_pdf, QuotePDFGenerationError
...
def _build_public_charge_buckets(lines, currency: str) -> list[dict]:
    ...
    for line in lines:
        if line.service_component:
            ...
            # Fall back to service_component.description only if not available

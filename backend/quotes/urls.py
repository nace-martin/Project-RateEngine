...
from .spot_views import (
    ...
    SpotChargeLineManualResolutionAPIView,
    SpotChargeLineConditionalResolutionAPIView,
...
urlpatterns = [
    ...
    path('v3/spot/envelopes/<uuid:envelope_id>/charges/<uuid:charge_line_id>/manual-resolution/', SpotChargeLineManualResolutionAPIView.as_view(), name='spot-charge-line-manual-resolution'),
    path('v3/spot/envelopes/<uuid:envelope_id>/charges/<uuid:charge_line_id>/conditional-resolution/', SpotChargeLineConditionalResolutionAPIView.as_view(), name='spot-charge-line-conditional-resolution'),

...
def build_fx_applied_payload(
    ...
    return {
        ...
        "source": fx_audit.get("fx_market_source") if isinstance(fx_audit, dict) and fx_audit.get("fx_market_source") else getattr(fx_snapshot, "source", None),
        "market_effective_date": fx_audit.get("fx_market_effective_date") if isinstance(fx_audit, dict) else None,
    ...
    *,
    ...
    return {
        ...
        "description": (
            ...
            or getattr(line, "cost_source_description", None)
            or getattr(service_component, "description", None)
            or "Charge"
        ),
        "component": component,

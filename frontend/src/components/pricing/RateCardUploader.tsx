...
type UploadStatus = 'ready' | 'uploading' | 'success' | 'validation_error' | 'error';
...
export function RateCardUploader() {
  ...
  async function handleUpload() {
    ...
    try {
      const uploadResult = await uploadV4RateCardCSV(selectedFile);
    ...
    <div className="space-y-6">
      <Card className="border-blue-100 shadow-sm">
        ...
        <CardContent className="space-y-5 pt-6">
          ...
          <div className="grid gap-4 rounded-xl border border-slate-200 bg-slate-50/60 p-4 md:grid-cols-[1fr_auto_auto] md:items-end">

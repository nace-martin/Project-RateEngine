...
export default function CrmReportsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    setError(null);
    try {
      const [interactionRows, opportunityRows, customerRows] = await Promise.all([
  ...
  }, [customers, interactions, opportunities]);
  ...
  return (
    <ProtectedRoute>
      <StandardPageContainer>
        <PageHeader
          title="CRM Reports"
          description="Simple CRM reports for activity, engagement risk, and outcomes."
          actions={
            <Button asChild variant="outline">
              <Link href="/crm">Overview</Link>
            </Button>
          }
        />

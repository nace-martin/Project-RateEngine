...
Prefer targeted tests and checks for the affected module. Do not use removed pricing implementation paths. Consult current source and maintained documentation rather than copying architecture facts into this adapter.
